export const domainConfig = {
    ...
    searchUrl: "https://whmcs.voltera.cloud/cart.php?a=add&domain=register&query=",

    registerUrl: "https://whmcs.voltera.cloud/cart.php?a=add&domain=register",
    pricing: [
        { tld: '.com', price: 9.95, renew: 12.95, transfer: 9.95, popular: true },
        { tld: '.net', price: 11.99, renew: 13.99, transfer: 11.99, popular: false },
        { tld: '.org', price: 12.50, renew: 14.50, transfer: 12.50, popular: false },
        { tld: '.io', price: 39.99, renew: 44.99, transfer: 39.99, popular: true },
        { tld: '.co', price: 23.95, renew: 26.95, transfer: 23.95, popular: false },
        { tld: '.id', price: 14.99, renew: 16.99, transfer: 14.99, popular: true },
        { tld: '.info', price: 4.99, renew: 19.99, transfer: 14.99, popular: false },
        { tld: '.biz', price: 5.99, renew: 17.99, transfer: 15.99, popular: false },
        { tld: '.xyz', price: 1.99, renew: 12.99, transfer: 12.99, popular: true },
        { tld: '.online', price: 0.99, renew: 34.99, transfer: 34.99, popular: false },
        { tld: '.shop', price: 2.99, renew: 39.99, transfer: 39.99, popular: false },
