...
import { resellerHostingConfig } from '../../config/reseller-hosting';

export const ResellerHostingPricing = () => {
    const { plans, sectionTitle, sectionDescription, currency } = resellerHostingConfig;
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {plans.map((plan, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`w-full md:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] relative bg-white dark:bg-gray-800 rounded-2xl flex flex-col overflow-hidden transition-all ${plan.isBestValue
