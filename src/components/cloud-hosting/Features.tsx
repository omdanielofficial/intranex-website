...
export const CloudHostingFeatures = () => {
    return (
        <section id="features" className="py-24 bg-white dark:bg-gray-950 overflow-hidden space-y-24 lg:space-y-32 scroll-mt-20">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 order-1 lg:order-2">
                        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                            Easy Essential Features
                        </h2>
                        <div className="space-y-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                            <p>
                                Our cloud hosting services cover all the essential features you need to build and run your website with ease.
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 order-1 lg:order-2">
                        ...
                        <div className="space-y-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                            <p>
                                <span className="font-bold text-gray-900 dark:text-white">Cloud plans</span> unlock powerful features for more complex workloads, including:
                            </p>
                            ...
                            <p>
                                Developers and power users can deploy and run advanced applications effortlessly with dedicated resources.
                            </p>
                        </div>
                    </div>
