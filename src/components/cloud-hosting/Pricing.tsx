...
import { cloudHostingConfig } from '../../config/cloud-hosting';

export const CloudHostingPricing = () => {
    const { plans, sectionTitle, sectionDescription, currency } = cloudHostingConfig;

    return (
        <section id="pricing" className="py-24 bg-gray-50 dark:bg-gray-900 font-sans scroll-mt-20">
